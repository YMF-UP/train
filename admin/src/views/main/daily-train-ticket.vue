<template>
  <p>
    <a-space>
      ...
      <station-select-view v-model="params.start" width="150px" placeholder="请选择出发站" />
      <station-select-view v-model="params.end" width="150px" placeholder="请选择到达站" />
  ...
  <a-table :dataSource="dailyTrainTickets"
    ...
    <template #bodyCell="{ column, record }">
      ...
      <template v-else-if="column.dataIndex === 'duration'">
        ...
        <div v-if="record.startTime > record.endTime" style="color: red">
          次日到达
        </div>
  ...
  <a-modal v-model:visible="visible" title="余票信息" @ok="handleOk"
    ...
    <a-form :model="dailyTrainTicket" :label-col="{span: 4}" :wrapper-col="{ span: 20 }">
      ...
      <a-form-item label="车次编号">
        <train-select-view v-model="dailyTrainTicket.trainCode" />
      </a-form-item>
      <a-form-item label="出发站">
        <station-select-view v-model="dailyTrainTicket.start" />
      </a-form-item>
      ...
      <a-form-item label="到达站">
        <station-select-view v-model="dailyTrainTicket.end" />
      </a-form-item>
