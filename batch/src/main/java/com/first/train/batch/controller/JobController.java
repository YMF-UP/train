package com.first.train.batch.controller;

import com.first.train.batch.req.CronJobReq;
import com.first.train.batch.resp.CronJobResp;
...
public class JobController {
    ...
    public CommonResp<List<CronJobResp>> query() {
        ...
        try {
            ...
            LOG.error("查看定时任务失败: {}", e.getMessage(), e);
            commonResp.setSuccess(false);
