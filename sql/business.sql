...
create table `daily_train_ticket` (
  ...
  `start_time` time not null comment '出发时间',
  `start_index` int not null comment '出发站序|本站是整个车次的第几站，第一站是0',
  `end` varchar(20) not null comment '到达站',
  `end_pinyin` varchar(50) not null comment '到达站拼音',
  `end_time` time not null comment '到站时间',
  `end_index` int not null comment '到站站序|本站是整个车次的第几站，第一站是0',
...
create table `confirm_order` (
  ...
  `tickets` json not null comment '车票，数据结构：[ConfirmOrderTicketReq]',
